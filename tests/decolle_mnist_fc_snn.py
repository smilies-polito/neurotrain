#!/usr/bin/env python3
"""
Unit-test for FCSNN + DECOLLETrainer on MNIST.
...
Usage:
    python test_decolle_fc_snn_mnist.py
    python test_decolle_fc_snn_mnist.py --epochs 2
    python test_decolle_fc_snn_mnist.py --optuna-trials 30 --optuna-epochs 15
    python test_decolle_fc_snn_mnist.py --epochs 20 --hpc-prints
"""
...
OPTUNA_TRIALS = 0
OPTUNA_EPOCHS = 20
STUDY_NAME = "decolle_fc_mnist_study"
OPTUNA_STORAGE = ""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Minimal MNIST+FCSNN DECOLLE test.")
