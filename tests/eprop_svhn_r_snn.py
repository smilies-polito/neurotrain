...
# -----------------------------------------------------------------------------
# Overfit test — fresh network, dataset, trainer (matching MNIST template)
# -----------------------------------------------------------------------------
def run_overfit_test(
    *,
    ...
    Creates everything from scratch so it doesn't contaminate or depend
    on the main training run.
    """
