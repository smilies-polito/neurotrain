#!/usr/bin/env python3
"""
Unit-test: RSNN + ESDRTRLTrainer on DVS Gesture.
...
OPTUNA_TRIALS = 0
OPTUNA_EPOCHS = 20
STUDY_NAME = "esdrtrl_dvsgesture_study"
OPTUNA_STORAGE = ""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="DVS Gesture + FCSNN ES-D-RTRL test.")
...
def run_training(
    *,
    ...
    # ── Dataset: DVS Gesture, 3×32×32, 10 classes ──
    ...
    # ── Network: in_shape matches DVS Gesture ──
    network = RSNN(
        in_shape=(2, 128, 128),
        num_classes=11,
