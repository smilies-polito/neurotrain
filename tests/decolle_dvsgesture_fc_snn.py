#!/usr/bin/env python3
"""
Unit-test for FCSNN + DECOLLETrainer on DVS Gesture.

Tests the DECOLLE online local-learning algorithm on the DVS Gesture
classification task using a fully-connected spiking network (FCSNN).

Usage:
    python test_decolle_fc_snn_dvsgesture.py
    python test_decolle_fc_snn_dvsgesture.py --epochs 2
    python test_decolle_fc_snn_dvsgesture.py --optuna-trials 30 --optuna-epochs 15
    python test_decolle_fc_snn_dvsgesture.py --epochs 20 --hpc-prints
"""
...
OPTUNA_TRIALS = 0
OPTUNA_EPOCHS = 20
STUDY_NAME = "decolle_fc_dvsgesture_study"
OPTUNA_STORAGE = ""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Minimal DVSGesture+FCSNN DECOLLE test.")
