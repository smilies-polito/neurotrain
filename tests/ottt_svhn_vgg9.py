#!/usr/bin/env python3
"""
OTTT trainer + unified VGG-9 + SVHN (direct/analog coding, 3×32×32, T=6).

Hyperparameters from Xiao et al. 2022 (same recipe as CIFAR-10):
  Optimizer: SGD, lr=0.1, momentum=0.9, CosineAnnealingLR
  lambda (loss_lambda): 0.05
  constant_input_per_timestep: True (direct coding)
