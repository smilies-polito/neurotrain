#!/usr/bin/env python3
"""
Unit-test for RSNN + DECOLLETrainer on DVS Gesture.

Tests the DECOLLE online local-learning algorithm on the DVS Gesture
classification task using a recurrent SNN (RSNN).

Usage:
    python test_decolle_rsnn_dvsgesture.py
    python test_decolle_rsnn_dvsgesture.py --epochs 2
    python test_decolle_rsnn_dvsgesture.py --optuna-trials 30 --optuna-epochs 15
    python test_decolle_rsnn_dvsgesture.py --epochs 20 --hpc-prints
"""
...
OPTUNA_TRIALS = 0
OPTUNA_EPOCHS = 20
STUDY_NAME = "decolle_rsnn_dvsgesture_study"
OPTUNA_STORAGE = ""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Minimal DVSGesture+RSNN DECOLLE test.")
