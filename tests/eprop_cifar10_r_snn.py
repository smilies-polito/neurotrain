#!/usr/bin/env python3
"""
Unit-test: RSNN + EpropTrainer on CIFAR-10.

Dataset:  CIFAR-10, 10 classes, 3×32×32 images.
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="CIFAR-10 + RSNN e-prop test.")
...
def run_training(
    *,
    ...
    # ── Dataset: CIFAR-10, 3×32×32, 10 classes ──
    ...
    # ── Network: in_shape matches CIFAR-10 ──
    network = RSNN(
        in_shape=(3, 32, 32),   # 3 channels, 32×32 → flattened = 3072
        num_classes=10,
