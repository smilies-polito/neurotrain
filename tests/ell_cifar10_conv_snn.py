#!/usr/bin/env python3
"""
Test for ELL-style local learning on ConvSNN + CIFAR-10.
...
Usage:
    python test_ell_conv_snn_cifar10.py
    python test_ell_conv_snn_cifar10.py --epochs 20 --beta 0.95
"""
...
OPTUNA_TRIALS = 0
OPTUNA_EPOCHS = 10
STUDY_NAME = "ell_conv_cifar10_study"
OPTUNA_STORAGE = ""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="CIFAR-10 + ConvSNN + ELL-style local learning test."
    )
...
def main() -> None:
    ...
    print(f"[ELL Conv CIFAR10 test] device={device.type}")
    print(f"[ELL Conv CIFAR10 test] beta={args.beta} threshold={args.threshold}")
    print(f"[ELL Conv CIFAR10 test] lr={args.lr} decay=÷{args.lr_decay_factor} every {args.lr_decay_every} ep")
    print(f"[ELL Conv CIFAR10 test] timesteps={args.timesteps} batch_size={args.batch_size} epochs={args.epochs}")
