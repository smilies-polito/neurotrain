#!/usr/bin/env python3
"""
Unit-test: RSNN + ESDRTRLTrainer on Fashion-MNIST.

Dataset:  Fashion-MNIST, 10 classes, 1×28×28 grayscale images.
Network:  Fully Connected SNN (FCSNN) with snnTorch RLeaky.
Trainer:  ES-D-RTRL (Wang et al. 2025) for classification.
"""
...
OPTUNA_TRIALS = 0
OPTUNA_EPOCHS = 20
STUDY_NAME = "esdrtrl_fmnist_study"
OPTUNA_STORAGE = ""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Fashion-MNIST + RSNN ES-D-RTRL test.")
