#!/usr/bin/env python3
"""
Unit-test for ConvSNN + DECOLLETrainer on DVS Gesture.
...
Usage:
    python test_decolle_conv_snn_dvsgesture.py
    python test_decolle_conv_snn_dvsgesture.py --epochs 2
    python test_decolle_conv_snn_dvsgesture.py --optuna-trials 30 --optuna-epochs 15
    python test_decolle_conv_snn_dvsgesture.py --epochs 20 --hpc-prints
"""
...
OPTUNA_TRIALS = 0
OPTUNA_EPOCHS = 20
STUDY_NAME = "decolle_conv_dvsgesture_study"
OPTUNA_STORAGE = ""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Minimal DVSGesture+ConvSNN DECOLLE test.")
