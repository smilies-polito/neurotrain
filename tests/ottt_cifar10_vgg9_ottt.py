#!/usr/bin/env python3
"""
Integration test: CIFAR-10 loader + OTTT_VGG9_CIFAR10 + OTTTTrainer.

This test verifies that the OTTT-SNN variant works correctly on CIFAR-10.
...
Architecture notes:
  OTTT_VGG9_CIFAR10 uses ScaledWSConv2d (Weight Standardization Conv) layers.
...
OPTUNA_TRIALS = 0
OPTUNA_EPOCHS = 5
STUDY_NAME = "ottt_cifar10_vgg9_ottt"
OPTUNA_STORAGE = ""
...
from networks.vgg9 import vgg9_ottt_cifar10 as OTTT_VGG9_CIFAR10
from trainers.ottt_trainer import OTTTTrainer


# Utilities
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="CIFAR-10 + OTTT_VGG9_CIFAR10 test.")
