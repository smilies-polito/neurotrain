...
![NeuroTrain benchmarking results — test accuracy heatmap, algorithms (rows) × architecture–dataset combinations (cols)](experiments/full_bench/results_heatmap.png)
...
*No NeuroBench metrics found in summary — run with `neurobench: true`.*
