...
![NeuroTrain benchmarking results — test accuracy heatmap, algorithms (rows) × architecture–dataset combinations (cols). Campaign: full_bench — 2026-04-30 23:02](../experiments/full_bench/results_heatmap.png)
*NeuroTrain — Benchmarking Results · Campaign: `full_bench` · 2026-04-30 23:02*
