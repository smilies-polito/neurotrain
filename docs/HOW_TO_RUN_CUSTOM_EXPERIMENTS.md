...
```bash
python3 src/generate_results.py experiments/my_campaign/

# With NeuroBench metrics
python3 src/generate_results.py experiments/my_campaign/ --neurobench
```
...
optuna-dashboard "sqlite:////absolute/path/to/experiments/my_campaign/experiments/<exp_name>/optuna/study.db"
