...
![NeuroTrain benchmarking results — test accuracy heatmap, algorithms (rows) × architecture–dataset combinations (cols)](/home/ldapusers/bardini/snn-training-benchmarking/experiments/full_bench/results_heatmap.png)
