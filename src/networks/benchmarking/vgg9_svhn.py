"""
Spiking VGG-9 for SVHN.

Identical architecture to vgg9_tp.py (traces_propagation BP_CNN variant 9),
adapted for SVHN:
  - in_channels=3  (RGB images)
  - num_classes=10 (SVHN digit classes 0-9)

Input per timestep: (B, 3, 32, 32)  — rate-coded SVHN frame.
...
class SVHN_VGG9(nn.Module):
    """VGG-9 SNN for SVHN (3-channel RGB, 10 classes)."""
    ...
    def __init__(
        ...
        if verbose:
            ...
            print(
                ...
                f"SVHN_VGG9  in_ch={in_channels}  classes={num_classes}"
...
if __name__ == '__main__':
    B, T = 2, 20
    model = SVHN_VGG9(in_channels=3, num_classes=10)
    model.init_states()
    ...
    print(f'SVHN_VGG9  output={spk_list[-1].shape}  params={n_params:,}')
